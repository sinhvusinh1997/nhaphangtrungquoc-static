...
import {Money, Order, Payment, Report, Surplus, ToolList, Transport} from "~/components/screens/mobile";
	...
	return (
		<div className={headerStyles}>
			...
			<span
				...
				style={{
					transform:
						defaultActiveKey?.filter((k) => k === keyActive).length > 0 ? "rotate3d(1, 0, 0, 180deg)" : "unset",
				}}
			>
