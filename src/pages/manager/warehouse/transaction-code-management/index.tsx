...
import {Layout, toast, TransactionCodeManagementFilter, TransactionCodeManagementTable} from "~/components";
...
const Index: TNextPageWithLayout = () => {
	...
	return (
		<div className="tableBox">
			<div className="">
				<TransactionCodeManagementFilter handleFilter={handleFilter} handleExporTExcel={handleExporTExcel} />
			</div>
