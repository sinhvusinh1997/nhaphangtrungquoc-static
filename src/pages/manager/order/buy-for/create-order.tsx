...
const Index: TNextPageWithLayout = () => {
	...
	const _onPress = (data: TUserCreateOrder) => {
		...
		mainOrder
			.addAnother({...data})
			.then(() => {
				toast.update(id, {render: "Tạo đơn thành công!", type: "success", isLoading: false, autoClose: 1000});
				router.push("/manager/order/order-list?q=3");
			})
			.catch((error) => {
				toast.update(id, {render: "Tạo đơn thất bại!", type: "success", isLoading: false, autoClose: 1000});
			});
	};
