...
const Index: TNextPageWithLayout = () => {
	...
	const handleExportExcelRecharge = async () => {
		try {
			const res = await reportAdminSendUserWallet.exportExcel({});
	...
	const handleExportExcelWithDraw = async () => {
		try {
			const res = await reportWithdraw.exportExcel({});
			router.push(`${res.Data}`);
		} catch (error) {
			toast.error(error);
		}
