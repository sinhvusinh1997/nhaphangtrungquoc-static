...
import {EmployeeManagementFilter, EmployeeManagementForm, EmployeeManagementTable, Layout, toast} from "~/components";
				...
				{...{
					...
					data:
						newUser?.UserGroupId !== 1
							? data?.Items.filter((item) => item?.UserGroupId !== 1 && item?.UserGroupId !== 9)
							: data?.Items.filter((item) => item.UserGroupId !== 9),
