...
import {InfoUserContact, InfoUserForm, InfoUserUpdateAvatar, showToast, toast, UserLayout} from "~/components";
...
const Index: TNextPageWithLayout = () => {
	...
	const {data, isError, refetch} = useQuery(["clientData", ids], () => user.getByID(ids), {
		onSuccess: (data) => {
			reset(data.Data);
