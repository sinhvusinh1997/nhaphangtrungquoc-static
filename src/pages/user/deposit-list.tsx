...
import {showToast, UserAnotherOrderInfo, UserDepositListFilter, UserDepositListTable, UserLayout} from "~/components";
import {EOrderStatusData, orderDataNumberOfOrder, orderMoneyOfOrdersData, transportStatus} from "~/configs/appConfigs";
	...
	return (
		<React.Fragment>
			...
			<div className="tableBox py-2">
				<UserAnotherOrderInfo numberOfOrder={transportStatus} moneyOfOrders={moneyOfOrders} />
