...
import {FormInput, FormInputNumber, FormTextarea, FormUpload, IconButton, showToast, UserLayout} from "~/components";
...
const Index: TNextPageWithLayout = () => {
	...
	const {data, isError, isLoading} = useQuery(["orderReportList", +query?.id], () => mainOrder.getByID(+query?.id), {
			...
			<div className="tableBox px-4 ">
				<div className="grid grid-cols-2 gap-4 ">
					...
					<div className="col-span-2">
						<FormTextarea control={control} name="ComplainText" label="Nội dung" placeholder="" required={false} />
					</div>
					<div className="col-span-2">
