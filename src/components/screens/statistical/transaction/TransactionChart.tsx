...
const TransactionChart = ({ dataChart }) => {
	...
	const data = {
		...
		datasets: [
			...
			{
				label: 'Thanh toán vận chuyển hộ',
			...
			{
				label: 'Nhận lại tiền vận chuyển hộ',
	...
	return (
		<React.Fragment>
			<p className="text-base !my-4 font-medium text-center text-active uppercase">Biểu đồ thống kê giao dịch</p>
