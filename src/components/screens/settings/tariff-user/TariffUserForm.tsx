					...
					<div className="grid grid-cols-2 gap-3">
						...
						<div className="col-span-2">
							<FormInputNumber
								control={control}
								name="FeeBuyPro"
								label="Chiết khấu phí mua hàng"
								placeholder="Chiết khấu phí mua hàng"
								rules={{
									required: "Không bỏ trống chiết khấu phí mua hàng",
									validate: (val: number) =>
						...
						<div className="col-span-2">
							<FormInputNumber
								control={control}
								name="FeeWeight"
								label="Chiết khấu phí vận chuyển TQ - VN"
								placeholder="Chiết khấu phí vận chuyển TQ - VN"
								rules={{
