		...
		<div className="xl:grid xl:grid-cols-5 xl:gap-4 w-full pb-4">
			<div className="col-span-1 xl:mb-0 mb-4">
				<FilterSelect
					data={searchData}
					label="Tìm kiếm theo"
					placeholder="Nhập nội dụng tìm kiếm"
					handleSearch={() => null}
					isClearable={true}
				/>
			</div>
			<div className="col-span-1 xl:mb-0 mb-4">
				<FilterInput {...usernameProps} handleSearch={(val: string) => (SearchContent.current = val.trim())} />
			</div>
			<div className="col-span-1 xl:mb-0 mb-4">
				<FilterSelect
			...
			<div className="col-span-1 xl:text-left text-left xl:mb-0 mb-4 flex items-end">
				<IconButton
					onClick={() =>
						handleFilter({
