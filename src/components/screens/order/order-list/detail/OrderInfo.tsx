...
const boxInfo = 'xl:col-span-1 col-span-2 p-4 bg-[#adc0c44d]';
const infoItem =
			...
			<div className="grid grid-cols-2 gap-4">
				<div className={clsx(boxInfo)}>
					...
					<div className="flex py-2 justify-between">
						...
						<div className="py-1 px-2">{data?.UserName}</div>
					</div>
					<div className={itemRows}>
						<div className={clsx(infoItem)}>Địa chỉ</div>
						<div className="py-1 px-2">{data?.Address}</div>
					</div>
					<div className={itemRows}>
						<div className={clsx(infoItem)}>Email</div>
						<div className="py-1 px-2">{data?.Email}</div>
					</div>
					<div className={itemRows}>
						<div className={clsx(infoItem)}>Số ĐT</div>
						<div className="py-1 px-2">{data?.Phone}</div>
					</div>
					{/* <div className={itemRows}>
						<div className={clsx(infoItem)}>Ghi chú</div>
						<div className="py-1 px-2">{data?.Note}</div>
					</div> */}
				</div>
				<div className={clsx(boxInfo)}>
					...
					<div className="flex justify-between py-2">
						...
						<div className=" py-1 px-2">{data?.ReceiverFullName}</div>
					</div>
					<div className={itemRows}>
						<div className={clsx(infoItem)}>Địa chỉ</div>
						<div className=" py-1 px-2">{data?.DeliveryAddress}</div>
					</div>
					<div className={itemRows}>
						<div className={clsx(infoItem)}>Email</div>
						<div className=" py-1 px-2">{data?.ReceiverEmail}</div>
					</div>
					<div className={itemRows}>
						<div className={clsx(infoItem)}>Số ĐT</div>
						<div className=" py-1 px-2">{data?.ReceiverPhone}</div>
					</div>
					{/* <div className={itemRows}>
						<div className={clsx(infoItem)}>Ghi chú</div>
						<div className=" py-1 px-2">{data?.Note}</div>
