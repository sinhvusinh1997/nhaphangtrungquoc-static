...
import {createdOrderStatusData, ECreatedOrderStatusData, employeeData, orderStatus} from "~/configs/appConfigs";
		...
		expandedRowRender: (record) => (
			<ul className="px-2 text-xs">
				<li className="sm:hidden justify-between flex py-2">
					<span className="font-medium mr-4">Thông tin:</span>
					<div>
						<div className="flex items-end justify-between">
							<p className="mr-1">Tỷ giá:</p>
							<p>3,845 Đ</p>
				...
				<li className="md:hidden justify-between flex py-2 diabled">
					<span className="font-medium mr-4 mb-4">Nhân viên đặt hàng:</span>
					<div className="mt-2">
						<FilterSelect
							placeholder="Chọn nhân viên"
							data={employeeData.slice(1)}
							handleSearch={(val) => console.log(val)}
							menuPortalTarget={document.querySelector("div.ant-table-wrapper")}
							styles={{
								menuPortal: (base) => {
				...
				<li className={`${RoleID === 1 || RoleID === 3 ? "" : "hidden"} lg:hidden justify-between flex py-2`}>
				...
				<li className="xl:hidden justify-between flex py-2">
					...
					<div>
						<div className="flex items-end justify-between">
							<p className="mr-1">Lên đơn:</p>
							<p>10:25 - 27/12/2021</p>
						</div>
						<div className="flex items-end justify-between">
							<p className="mr-1">Đặt cọc:</p>
							<p>10:32 - 27/12/2021</p>
						</div>
					</div>
				</li>
				<li className="xl:hidden justify-between flex py-2">
