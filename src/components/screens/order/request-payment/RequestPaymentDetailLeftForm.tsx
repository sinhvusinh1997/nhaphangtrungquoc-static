...
export const RequestPaymentDetailLeftForm: React.FC<TProps> = ({handleSubmit, getValues, onPress, loading, data}) => {
	return (
		<Affix offsetTop={20}>
			<div>
				<div className="tableBox">
					<div className="flex border-b border-[#0000001a]">
						<div className="w-2/4 p-2 text-sm font-bold text-[#6d6d6d]">
							<Skeleton loading={loading} paragraph={{rows: 1, width: 100}} title={false}>
								ID
							</Skeleton>
						</div>
					...
					<div className="flex border-b border-[#0000001a]">
						...
						<div className="w-2/4 p-2 text-sm font-medium text-[#6d6d6d]">
							<Skeleton loading={loading} paragraph={{rows: 1, width: 100}} title={false}>
								...
								<Tag color={paymentData[data?.Data?.Status]?.color}>{paymentData[data?.Data?.Status]?.name}</Tag>
							</Skeleton>
						</div>
					</div>
					<div className="flex border-b border-[#0000001a]">
