...
export const EmployeeManagementFilter: FC<TProps> = ({
	...
	return (
		<>
			<div className="xl:grid grid-cols-5 gap-4 pb-4">
				...
				<div className="col-span-1 mb-4 xl:mb-0 ">
					<FilterSelect
						data={userGroupCatalogue?.filter((x) => x.Code !== "USER" && x.Code !== "STOREKEEPERS")}
				...
				<div className="col-span-3 xl:mb-0 flex justify-between items-end">
					<IconButton
						onClick={() =>
							handleFilter({
