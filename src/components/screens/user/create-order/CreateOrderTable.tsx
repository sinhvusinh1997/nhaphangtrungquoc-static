		...
		expandedRowRender: (_, __, index) => (
			<ul className="px-2 text-xs">
				<li className="sm:hidden justify-between flex py-2 ">
					<span className="font-medium mr-4 w-20">Hình sản phẩm:</span>
					<FormUpload
						image
						control={control}
						name={`Products.${index}.ImageProduct` as const}
				...
				<li className="sm:hidden justify-between flex py-2">
					<span className="font-medium mr-4 w-20">Link sản phẩm:</span>
					<FormInput
						control={control}
						name={`Products.${index}.LinkProduct` as const}
						placeholder=""
				...
				<li className="lg:hidden justify-between flex py-2 ">
					<span className="font-medium mr-4 w-20">Tên sản phẩm:</span>
					<FormInput
						control={control}
						name={`Products.${index}.NameProduct` as const}
						placeholder=""
				...
				<li className="lg:hidden justify-between flex py-2">
					<span className="font-medium mr-4 w-20">Giá sản phẩm:</span>
					<FormInputNumber
						control={control}
						name={`Products.${index}.PriceProduct` as const}
						placeholder=""
				...
				<li className="xl:hidden justify-between flex py-2">
					<span className="font-medium mr-4 w-16">Số lượng:</span>
					<FormInputNumber
						control={control}
						name={`Products.${index}.QuantityProduct` as const}
						placeholder=""
