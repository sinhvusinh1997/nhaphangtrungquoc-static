	...
	return (
		<React.Fragment>
			<div className="xl:grid grid-cols-2 gap-4">
					...
					<div className="w-full">
						<div className="mt-2 xl:mt-0 w-full">
							<FormSelect
								...
								control={control}
								name="UID"
								placeholder={Array.isArray(user) ? "Chọn khách hàng" : `${user?.UserName}`}
								select={{label: "UserName", value: "Id"}}
								rules={Array.isArray(user) ? {required: "This field is required"} : {}}
				...
				<div className="col-span-1 xl:flex items-center xl:mb-0 mb-2">
				...
				<div className="col-span-1 xl:flex items-center">
