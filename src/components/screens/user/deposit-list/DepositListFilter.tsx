...
import {EOrderStatusData, ESearchData, orderStatusData, searchData} from "~/configs/appConfigs";
...
export const UserDepositListFilter: React.FC<TProps> = ({handleFilter, numberOfOrder}) => {
