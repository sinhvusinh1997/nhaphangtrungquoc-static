...
export const HistoryTransactionVNDTable: React.FC<TTable<TUserHistoryTransactionVND> & {filter; handleFilter}> = ({
	data,
	filter,
	handleFilter,
	loading,
		...
		expandedRowRender: (record) => (
			<ul className="px-2 text-xs">
				<li className="md:hidden justify-between flex py-2">
					...
					{(isNumber(record.MoneyLeft) && _format.getVND(record.MoneyLeft)) || "0 VND"}
				</li>
				<li className="md:hidden justify-between flex py-2">
