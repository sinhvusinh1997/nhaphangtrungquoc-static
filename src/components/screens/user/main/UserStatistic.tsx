...
const box = "flex items-center justify-center lg:justify-between sm:flex-wrap lg:flex-nowrap";

const BoxItem = ({value, path, label, icon, color}) => {
	const boxItem = "md:px-4 md:py-4 p-4 w-[48%] lg:w-[24%] bg-[#fff] lg:my-0 shadow-xl hover:shadow-none transition-all";
	const titleContain = "";
