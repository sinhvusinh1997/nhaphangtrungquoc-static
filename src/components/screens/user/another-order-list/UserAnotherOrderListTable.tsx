									...
									Modal.confirm({
										...
										onOk: () => {
											...
											orderShopTemp
												...
												.catch((error) => {
													toast.update(id, {render: "Thêm đơn thất bại!", type: "error", isLoading: false});
												});
										},
									})
								}
			...
			<ul className="px-2 text-xs">
				...
				<li className="xl:hidden flex  justify-between py-2">
					...
					<div>
						{record.Created && (
							<p>
								Lên đơn: {_format.getVNDate(record.Created, "HH:mm")} -{_format.getVNDate(record.Created, "DD/MM/YYYY")}
							</p>
						)}
						{record.DepositDate && (
							<p>
								Đặt cọc: {_format.getVNDate(record.DepositDate, "HH:mm")} -
								{_format.getVNDate(record.DepositDate, "DD/MM/YYYY")}
							</p>
						)}
						{record.DateBuy && (
							<p>
								Đặt hàng: {_format.getVNDate(record.DateBuy, "HH:mm")} -
								{_format.getVNDate(record.DateBuy, "DD/MM/YYYY")}
							</p>
						)}
						{record.DateTQ && (
							<p>
								Đã về kho TQ: {_format.getVNDate(record.DateTQ, "HH:mm")} -
								{_format.getVNDate(record.DateTQ, "DD/MM/YYYY")}
							</p>
						)}
						{record.DateVN && (
							<p>
								Đã về kho VN: {_format.getVNDate(record.DateVN, "HH:mm")} -
								{_format.getVNDate(record.DateVN, "DD/MM/YYYY")}
							</p>
						)}
						{record.PayDate && (
							<p>
								Thanh toán: {_format.getVNDate(record.PayDate, "HH:mm")} -
								{_format.getVNDate(record.PayDate, "DD/MM/YYYY")}
							</p>
						)}
						{record.CompleteDate && (
							<p>
								Hoàn thành: {_format.getVNDate(record.CompleteDate, "HH:mm")} -
								{_format.getVNDate(record.CompleteDate, "DD/MM/YYYY")}
							</p>
						)}
					</div>
				...
				<li className="xl:hidden justify-between flex py-2">
					...
					<Space>
						...
						<ActionButton
							...
							icon="fas fa-minus-octagon"
							title="Khiếu nại"
							btnRed
						/>
						{record.Status === ECreatedOrderStatusData.Undeposited && (
							<ActionButton
								onClick={() => handleModal([record], undefined, "one")}
								icon="far fa-dollar-sign"
								title="Đặt cọc"
								btnYellow
							/>
