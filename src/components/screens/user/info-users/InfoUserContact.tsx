	...
	return (
		<div className="w-full">
			...
			<div className="w-full items-center text-center xl:p-8 p-4 rounded-3xl mt-[-106px] z-50 relative">
				<div className="bg-white rounded-3xl p-6 xl:grid grid-cols-3 boxShadow">
					<div className="col-span-1 flex">
						<div className="border-2 border-[#0c5963] rounded-full p-2 mr-4 border-unactive h-14 xl:h-full overflow-hidden relative">
							<Avatar size={{xxl: 100}} src={data?.AvatarIMG ? data.AvatarIMG : "/empty_avatar.jpg"} />
						</div>
						<div className="text-left">
							<p className="font-medium xl:text-2xl text-xl xl:mt-4">{data?.UserName}</p>
							<button onClick={onOpenModal} className="text-blue flex lg:text-sm text-xs xl:mt-2">
					...
					<ul className="col-span-1 text-xs mt-4 mb-0">
						<li className="flex xl:text-base py-2">
