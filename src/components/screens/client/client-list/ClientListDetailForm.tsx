...
import {FormDate, FormInput, FormInputNumber, FormRadio, FormSelect, IconButton} from "~/components";
...
export const ClientListDetailForm: React.FC<TProps> = ({
	...
	const mutationUpdate = useMutation(user.update, {
		onSuccess: () => {
			...
			router.push("/manager/client/client-list");
		},
		onError: toast.error,
	});
			...
			<div className="grid grid-cols-2 gap-4">
				<div className="tableBox span-col-1 h-fit">
					<div className="grid grid-cols-4 gap-4">
						<div className="col-span-4 font-bold text-[22px]">Cấu hình người dùng</div>
						...
						<div className="col-span-2">
							<FormDate label="Ngày sinh" name="Birthday" control={control} placeholder="Nhập ngày sinh" />
						</div>
						<div className="col-span-2">
							<FormInput
								type="email"
						...
						<div className="col-span-2">
							<FormRadio label="Giới tính" data={genderData} name="Gender" control={control} />
						</div>
						<div className="col-span-2">
							<FormInput
								control={control}
										...
										? {
												...
												validate: {
													checkEqualPassword: (value) => {
														return getValues("PasswordNew") === value || createComplain();
													},
												},
										  }
										: {}
					...
					<div className="grid grid-cols-4 gap-4">
						...
						<div className="col-span-2">
							<FormSelect
								...
								defaultValue={{
									UserName:
										userSaleCatalogue?.find((item) => item.Id === defaultValues?.SaleId)?.UserName ??
						...
						<div className="col-span-2">
							<FormSelect
								...
								defaultValue={{
									UserName:
										userOrderCatalogue?.find((item) => item.Id === defaultValues?.DatHangId)?.UserName ??
										"Chọn nhân viên đặt hàng",
						...
						<div className="col-span-2">
							<FormSelect
								...
								defaultValue={{
									Name:
										userLevelCatalogue?.find((item) => item.Id === defaultValues?.LevelId)?.Name ??
										"Chọn cấp người dùng",
						...
						<div className="col-span-2">
							<FormSelect
								...
								callback={(val) => {
									UserGroupNameCur.current = userGroupCatalogue.find((item) => item.Id === val)?.Name;
								}}
							/>
						</div>
						<div className="col-span-2">
						...
						<div className="col-span-4 pt-3 mt-3 border-t border-[#ccc] text-right">
							<IconButton
